...
public:
    ...
    void sort() {
        nodes.mergeSort(0, nodes.size() - 1);
    }
...
class Graph {
    ...
    void currCC(vector <int> &cc, vector <bool> &used, int node) {
        cc.push_back(node);
        used[node] = true;
...
//        nextNodeInPath = other.nextNodeInPath;
    ...
    void sort() {
        ...
        for (int NodeListInd = 0; NodeListInd < G.size(); ++NodeListInd) {
            G[NodeListInd].sort();
        }
    }
    ...
    Graph operator * (const Graph &other) const {
        ...
        g1.edges.mergeSort(0, g1._edgeCnt - 1);
        g2.edges.mergeSort(0, g2._edgeCnt - 1);
